...
The2022 <- HolisticToArchived(data=The2022, manufacturer="Cytek",
 baselinecutoffs=QC_Cutoffs, gainmultiplier = 2)
```

## {.sidebar}
Dashboard contains historical data from **2022** for the **Cytek Aurora 3L**.
...
CSVname <- paste0("Historical_Aurora3L_2022.csv")
