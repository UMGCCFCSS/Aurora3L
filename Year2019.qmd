...
The2019 <- HolisticToArchived(data=The2019, manufacturer="Cytek",
 baselinecutoffs=QC_Cutoffs, gainmultiplier = 2)
```

## {.sidebar}
Dashboard contains historical data from **2019** for the **Cytek Aurora 3L**.
...
Filename <- paste0("Historical_Aurora3L_2019")
...
CSVname <- paste0("Historical_Aurora3L_2019.csv")
