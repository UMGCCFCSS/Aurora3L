...
The2023 <- HolisticToArchived(data=The2023, manufacturer="Cytek",
 baselinecutoffs=QC_Cutoffs, gainmultiplier = 2)
```

## {.sidebar}
Dashboard contains historical data from **2023** for the **Cytek Aurora 3L**.
...
CSVname <- paste0("Historical_Aurora3L_2023.csv")
