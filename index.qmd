...
<ul>
  ...
  <li><a href='data/Historical_Aurora3L_2020.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora3L_2022.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora3L_2024.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora3L_2021.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora3L_2023.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='https://umgccfcss.github.io/InstrumentQC/data/3L/Archive/BeadData3L.csv'>Gain, RCV and MFI</a></li>
</ul>
")
